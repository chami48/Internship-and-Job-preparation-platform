/*
  ...
  - You are about to drop the column `email` on the `ApplicantVerification` table. All the data in the column will be lost.
  - Added the required column `userId` to the `ApplicantVerification` table without a default value. This is not possible if the table is not empty.
...
INSERT INTO "new_ApplicantVerification" ("createdAt", "fullName", "id", "idImageUrl", "role", "studentIdNumber") SELECT "createdAt", "fullName", "id", "idImageUrl", "role", "studentIdNumber" FROM "ApplicantVerification";
...
INSERT INTO "new_Application" ("awards", "cgpa", "createdAt", "degree", "email", "examSubmitted", "frameworks", "fullName", "github", "id", "jobId", "linkedin", "lockedQuestions", "mobile", "portfolio", "programmingLanguages", "role", "softwareProficiency", "specialization", "university") SELECT "awards", "cgpa", "createdAt", "degree", "email", "examSubmitted", "frameworks", "fullName", "github", "id", "jobId", "linkedin", "lockedQuestions", "mobile", "portfolio", "programmingLanguages", "role", "softwareProficiency", "specialization", "university" FROM "Application";

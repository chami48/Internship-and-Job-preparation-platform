...
test.describe("Company Module Testing", () => {
  ...
  test("Company Registration Form Works", async ({ page }) => {
    ...
    await page.getByPlaceholder("hr@company.com").fill("demo@company.com");
  ...
  test("Company Login Success", async ({ page }) => {
    ...
    await page
      .getByPlaceholder("hr@company.com")
      .fill("nilumidakshika5@gmail.com");

    await page.getByPlaceholder("Your password").fill("Nilumi123#");
  ...
  test("Company Login Fail", async ({ page }) => {
    ...
    await page.getByPlaceholder("hr@company.com").fill("wrong@company.com");
  ...
  test("Create Job Post", async ({ page }) => {
    ...
    // STEP 1: JOB BASICS
    await page
      .getByPlaceholder("e.g. Frontend Developer")
      .fill("Frontend Intern");

    await page.getByPlaceholder("e.g. Colombo, Sri Lanka").fill("Colombo");
    ...
    await page
      ...
      .nth(0)
      .fill(
        "We are hiring a frontend intern with strong React knowledge and real-world project experience",
      );
    ...
    await page
      ...
      .nth(1)
      .fill(
        "Develop user interfaces, collaborate with team members, fix bugs, and participate in code reviews",
      );
    ...
    await page
      ...
      .nth(2)
      .fill(
        "Strong knowledge of React, JavaScript, problem solving, teamwork, and communication skills",
      );

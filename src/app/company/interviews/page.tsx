...
const interviews: Interview[] = [
  {
    id: "i1",
    candidate: "Nirmi Kawmada",
    jobTitle: "AI Engineer Intern",
    stage: "Final",
    type: "Remote",
    scheduledAt: "2026-04-22T12:30:00+05:30",
    timezone: "GMT+5:30",
    location: "Google Meet",
    interviewer: "Priya (Lead ML)",
    status: "Confirmed",
    contact: { email: "nirmi.kawmada@gmail.com", phone: "+94 77 111 2222" },
  },
  {
    id: "i1a",
    candidate: "Sahan Perera",
    jobTitle: "AI Engineer Intern",
    stage: "Technical",
    type: "Remote",
    scheduledAt: "2026-05-10T10:00:00+05:30",
    timezone: "GMT+5:30",
    location: "Google Meet",
    interviewer: "Priya (Lead ML)",
    status: "Scheduled",
    contact: { email: "sahan.perera@gmail.com", phone: "+94 77 222 3333" },
  },
  {
    id: "i1b",
    candidate: "Dilani Fernando",
    jobTitle: "AI Engineer Intern",
    stage: "Screen",
    type: "Onsite",
    scheduledAt: "2026-06-05T14:00:00+05:30",
    timezone: "GMT+5:30",
    location: "Colombo HQ - Room 1A",
    interviewer: "Priya (Lead ML)",
    status: "Scheduled",
    contact: { email: "dilani.fernando@gmail.com", phone: "+94 77 444 5555" },
  },
  {
    id: "i2",
    candidate: "Dasuni Tharaki",
    jobTitle: "Frontend Engineer",
    stage: "Technical",
    type: "Onsite",
    scheduledAt: "2026-04-22T15:30:00+05:30",
    timezone: "GMT+5:30",
    location: "Colombo HQ - Room 3B",
    interviewer: "Amal (FE Lead)",
    status: "Scheduled",
    contact: { email: "dasuni.tharaki@gmail.com", phone: "+94 71 234 5678" },
  },
  {
    id: "i2a",
    candidate: "Nadeesha Silva",
    jobTitle: "Frontend Engineer",
    stage: "Screen",
    type: "Remote",
    scheduledAt: "2026-05-15T11:00:00+05:30",
    timezone: "GMT+5:30",
    location: "Google Meet",
    interviewer: "Amal (FE Lead)",
    status: "Scheduled",
    contact: { email: "nadeesha.silva@gmail.com", phone: "+94 71 555 6666" },
  },
  {
    id: "i2b",
    candidate: "Chathura Jayasuriya",
    jobTitle: "Frontend Engineer",
    stage: "Final",
    type: "Onsite",
    scheduledAt: "2026-06-12T09:30:00+05:30",
    timezone: "GMT+5:30",
    location: "Colombo HQ - Room 3B",
    interviewer: "Amal (FE Lead)",
    status: "Scheduled",
    contact: { email: "chathura.jayasuriya@gmail.com", phone: "+94 71 777 8888" },
  },
  {
    id: "i3",
    candidate: "Ravindu Perera",
    jobTitle: "Backend Developer",
    stage: "Technical",
    type: "Remote",
    scheduledAt: "2026-04-23T10:30:00+05:30",
    timezone: "GMT+5:30",
    location: "Google Meet",
    interviewer: "Sahan (BE Lead)",
    status: "Scheduled",
    contact: { email: "ravindu.perera@gmail.com", phone: "+94 77 888 9999" },
  },
  {
    id: "i3a",
    candidate: "Thilina Madushanka",
    jobTitle: "Backend Developer",
    stage: "Screen",
    type: "Onsite",
    scheduledAt: "2026-05-20T14:30:00+05:30",
    timezone: "GMT+5:30",
    location: "Colombo HQ - Room 2B",
    interviewer: "Sahan (BE Lead)",
    status: "Scheduled",
    contact: { email: "thilina.madushanka@gmail.com", phone: "+94 77 999 0000" },
  },
  {
    id: "i3b",
    candidate: "Isuru Wijesinghe",
    jobTitle: "Backend Developer",
    stage: "Final",
    type: "Remote",
    scheduledAt: "2026-06-18T16:00:00+05:30",
    timezone: "GMT+5:30",
    location: "Google Meet",
    interviewer: "Sahan (BE Lead)",
    status: "Scheduled",
    contact: { email: "isuru.wijesinghe@gmail.com", phone: "+94 77 222 3333" },
  },
  {
    id: "i4",
    candidate: "Ishara Fernando",
    jobTitle: "QA Engineer",
    stage: "Screen",
    type: "Onsite",
    scheduledAt: "2026-04-23T11:30:00+05:30",
    timezone: "GMT+5:30",
    location: "Colombo HQ - Room 2A",
    interviewer: "Nadeesha (QA Lead)",
    status: "Scheduled",
    contact: { email: "ishara.fernando@gmail.com", phone: "+94 76 555 4444" },
  },
  {
    id: "i4a",
    candidate: "Sanduni Jayawardena",
    jobTitle: "QA Engineer",
    stage: "Technical",
    type: "Remote",
    scheduledAt: "2026-05-25T13:00:00+05:30",
    timezone: "GMT+5:30",
    location: "Google Meet",
    interviewer: "Nadeesha (QA Lead)",
    status: "Scheduled",
    contact: { email: "sanduni.jayawardena@gmail.com", phone: "+94 76 111 2222" },
  },
  {
    id: "i4b",
    candidate: "Manori Abeysekara",
    jobTitle: "QA Engineer",
    stage: "Final",
    type: "Onsite",
    scheduledAt: "2026-06-22T15:30:00+05:30",
    timezone: "GMT+5:30",
    location: "Colombo HQ - Room 2A",
    interviewer: "Nadeesha (QA Lead)",
    status: "Scheduled",
    contact: { email: "manori.abeysekara@gmail.com", phone: "+94 76 333 4444" },
  },
];
...
export default function InterviewsPage() {
  ...
  // Custom logic for demo: always 1 in today, 3 in upcoming as specified
  const allToday = sortedByTime.filter((i) => isSameDay(new Date(i.scheduledAt), today));
  const todayInterviews: Interview[] = allToday.length > 0 ? [allToday[0]].filter((i): i is Interview => !!i) : [];
  // Find the 3 required for upcoming: 1 for 22nd 3:30PM, 2 for 23rd 10:30AM, 11:30AM
  const upcoming = [
    ...sortedByTime.filter(i => i.scheduledAt === "2026-04-22T15:30:00+05:30"),
    ...sortedByTime.filter(i => i.scheduledAt === "2026-04-23T10:30:00+05:30"),
    ...sortedByTime.filter(i => i.scheduledAt === "2026-04-23T11:30:00+05:30"),
  ];
          ...
          <div className="space-y-5">
            <div className="bg-[#F8FBFF] border border-[#E2E8F0] rounded-2xl shadow-sm">
              ...
              <div className="px-5 py-4 space-y-4">
                {todayInterviews.filter((i): i is Interview => !!i).map((i) => (

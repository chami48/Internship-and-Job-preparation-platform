    ...
    <main className="min-h-[calc(100vh-140px)] bg-white px-4 py-14">
      <div className="mx-auto max-w-3xl rounded-3xl border border-gray-200 bg-white p-8 shadow-sm">
        ...
        <div className="mt-8 flex gap-4">
          <Link
            href={`/apply/${job.id}`}
            className="rounded-2xl bg-orange-500 px-6 py-3 text-sm font-medium text-white hover:bg-orange-600"
          >
            Apply Now
          </Link>
          ...
          <Link
            href="/"
            className="rounded-2xl border border-gray-200 bg-white px-6 py-3 text-sm text-gray-700 hover:bg-gray-50"
          >
            Back
          </Link>
        </div>
